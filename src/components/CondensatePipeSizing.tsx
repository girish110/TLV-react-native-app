...
const data = [
  { id: '1', title: 'Condensate Recovery Pipe Sizing Between Equipment and Trap', screen: 'Equipment_and_Trap' },
  { id: '2', title: 'Condensate Recovery Pipe Sizing for Codensate Recovery Line by Pressure Loss', screen: 'Recovery_Line_By_Pressure_Loss' },
